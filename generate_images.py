...
async def generate_languages(s: Stats) -> None:
    ...
    print(langs.keys)
    default_lang = {"size": 0}
    langs["Python"]["size"] = langs.get("Jupyter Notebook", default_lang)["size"]/8 + langs.get("Python",default_lang)["size"]
    langs["PHP"]["size"] = langs.get("Blade",default_lang)["size"] + langs.get("PHP",default_lang)["size"]
